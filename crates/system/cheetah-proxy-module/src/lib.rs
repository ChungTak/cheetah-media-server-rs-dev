...
//!
//! The data plane is currently a stub that maintains state and cancellation
//! lifecycle; full connector integration is gated behind the optional
//! `cheetah-connector` feature and will be wired in a follow-up change.
