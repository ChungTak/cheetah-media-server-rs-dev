...
proptest! {
    /// An H264 coded frame always maps to a Video FLV payload whose tag header
    /// encodes the correct frame type (keyframe 0x17 vs interframe 0x27 in
    /// legacy/Normal mode) followed by the AVC NALU packet-type byte 0x01.
    #[test]
