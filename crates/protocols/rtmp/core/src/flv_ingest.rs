...
/// `apply_flv_metadata_to_tracks` function.
/// `apply_flv_metadata_to_tracks` 函数.
...
/// `apply_flv_video_config` function.
/// `apply_flv_video_config` 函数.
...
/// Parses `flv_hvcc_parameter_sets` from input.
/// 解析 `flv_hvcc_parameter_sets` 来自 输入.
...
/// Parses `flv_avcc_parameter_sets` from input.
/// 解析 `flv_avcc_parameter_sets` 来自 输入.
...
/// `update_timestamp_repair_counter` function.
/// `update_timestamp_repair_counter` 函数.
