...
/// `RtmpModuleConfig` data structure.
/// `RtmpModuleConfig` 数据结构.
...
/// `RtmpPullJobConfig` data structure.
/// `RtmpPullJobConfig` 数据结构.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(default)]
...
/// `RtmpPushJobConfig` data structure.
/// `RtmpPushJobConfig` 数据结构.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(default)]
...
/// `RtmpRelayJobConfig` data structure.
/// `RtmpRelayJobConfig` 数据结构.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(default)]
