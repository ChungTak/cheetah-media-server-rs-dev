//! Shared helpers for RTSP integration tests in the connector crate.
//!
//! 这些 helper 与 `cheetah-rtsp-module` 测试中的 helper 同名，但独立复制到
//! connector 测试目录，避免跨 crate tests/ 目录依赖。
