...
| release evidence draft | BLOCKED | 新增 `dev-docs/release_evidence/v0.1.0-draft-2026-07-24.md`，汇总 commit/Cargo.lock、fmt/clippy/test 结果、能力矩阵状态；24h 长稳、真实设备互操作、性能基线、SBOM、外部 adapter mTLS 轮换与 automated secret scan 未完成 (REL-01) |
